    ...
    if (symptoms.fever || (symptoms.cough && symptoms.soreThroat) || (symptoms.cough && symptoms.muscularPain) || (symptoms.fever && symptoms.diarrhea)) {
      if (fact_gravite_maj > 0) {
        ...
        if (((ppf.age > 50 && ppf.age < 70) && fact_gravite_min === 0) || fact_gravite_min > 0) {
          this.resultat = 'تقد تشاور مع طبيب فتيليفون او يزورك طبيب فالدار' +
            '<br>إذا كان عندك صعوبة فالتنفس او مقديتيش تاكل مزيان او تشرب لكثر من 24 ساعة ضروري اتصل ب 141';
        }
      } else {
      ...
      if (fact_gravite_maj === 0 && fact_gravite_min === 0) {
        ...
        this.resultat = 'موحال واش فيك فيروس كورونا ؛ تنصحوك تشاور مع طبيب. وإلى كان فيك الشك اتصل ب 141';
      }
    } else {
      this.resultat = 'موحال واش فيك فيروس كورونا، إذا عندك شك تصل بطبيب ديالك. تقد تعاود الإختبار لكانوا عندك اعراض اخرى. لبغيتي تعرف اكثر على الڤيروس ممكن تشوف صفحة النصائح';
    }
  }
